...
def load_data(filename):
    ...
    with open(filename) as f:
        ...
        for row in reader:
            ...
            initial_evidence[1] = float(initial_evidence[1])
            initial_evidence[3] = float(initial_evidence[3])
            initial_evidence[5] = float(initial_evidence[5])
            initial_evidence[6] = float(initial_evidence[6])
            initial_evidence[7] = float(initial_evidence[7])
            initial_evidence[8] = float(initial_evidence[8])
            initial_evidence[9] = float(initial_evidence[9])
